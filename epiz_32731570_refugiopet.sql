...
--
ALTER TABLE `ANIMAL`
  ADD PRIMARY KEY (`IDANIMAL`,`ADM_ID`,`RACA_ID`),
  ADD KEY `FK_ANIMAL_ADM_IDX` (`ADM_ID`),
  ADD KEY `FK_ANIMAL_RACA1_IDX` (`RACA_ID`);
...
--
ALTER TABLE `ANIMAL`
  ADD CONSTRAINT `FK_ANIMAL_ADM` FOREIGN KEY (`ADM_ID`) REFERENCES `ADM` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_ANIMAL_RACA1` FOREIGN KEY (`RACA_ID`) REFERENCES `RACA` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
